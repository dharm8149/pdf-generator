...
//var hor=require('./hor')
try{
horizontal(data,pdfDoc)

const {dialog}=require('electron')
const response=dialog.showMessageBox(null,{message:"Come Here Before Final"+test})
...
pdfDoc.end();
    ...
    const response=dialog.showMessageBox(null,{message:JSON.stringify(err)})
    console.log(response)
}
...
function horizontal(test,pdfDoc){
    const {dialog}=require('electron')
    const response=dialog.showMessageBox(null,{message:"Come Here Horixontal"+test})
    console.log(response)
 ...
 for(let j of test){
     ...
     const response=dialog.showMessageBox(null,{message:"Come Here Before Vertical"+test})
     console.log(response)
 ...
 function vertical(x,y,height,pdfDoc){
     const {dialog}=require('electron')
     const response=dialog.showMessageBox(null,{message:"Come Here Vertical"})
     console.log(response)
     pdfDoc.moveTo(30,76)
     ...
     function draw(pdfDoc){
        const {dialog}=require('electron')
        const response=dialog.showMessageBox(null,{message:"Come Here HeadFoot"})
        console.log(response)
